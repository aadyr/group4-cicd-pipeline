...
[<img src=(https://img.shields.io/github/last-commit/:aadyr/:group4-cicd-pipeline) />](https://img.shields.io/github/all-contributors/aadyr/group4-cicd-pipeline/:branch
)
